...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '重启艺术 RestArt', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-wine-pi.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '重启艺术 RestArt, 博客', // 网站关键词 英文逗号隔开
